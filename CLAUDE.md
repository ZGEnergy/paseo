...
| [docs/development.md](docs/development.md)                           | Dev server, build sync gotchas, local desktop build signing, CLI reference, agent state, Playwright MCP                        |
...
| [docs/onboarding.md](docs/onboarding.md)                             | Getting a teammate onto the fork: daemon bootstrap, clients, local desktop builds                                              |
